...
<div class="easy-date-selection easy-ui" id="easy_selection_<?php echo esc_attr( $uid ); ?>">
    ...
    <div class="header">
        <?php if ( $display_departure ): ?>
            ...
            <span class="text">
                <span class="date">
                    <?php if ( $departure !== false ) echo esc_html( $departure ); else echo '&#8212;'; ?>
                </span>
                <span class="time">
                    <?php if ( $departure_time ) echo esc_html( date( er_time_format(), $departure_time ) ); ?>
                </span>
            </span>
        </div>
        <?php endif; ?>
        <div class="arrival">
            <?php if( $departure ) esc_html_e( 'Arrival', 'easyReservations' ); else esc_html_e( 'Date', 'easyReservations' ); ?>
            <span class="text">
                <span class="date">
                    <?php
                    if ( $arrival ) {
                ...
                <span class="time">
                    <?php if ( $arrival_time !== false ) echo esc_html( date( er_time_format(), $arrival_time ) ); ?>
                </span>
            </span>
