 ...
 *
 * This template can be overridden by copying it to yourtheme/easyreservations/emails/admin-cancelled-order.php.
 *
...
<?php /* translators: %1$s: Order number, %2$s: Customer full name.  */ ?>
    <p><?php printf( esc_html__( 'Alas. Just to let you know &mdash; order #%1$s belonging to %2$s has been cancelled:', 'easyReservations' ), esc_html( $order->get_order_number() ), esc_html( $order->get_formatted_full_name() ) ); ?></p>
