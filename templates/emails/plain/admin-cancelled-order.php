 ...
 *
 * This template can be overridden by copying it to yourtheme/easyreservations/emails/plain/admin-cancelled-order.php.
 *
...
echo sprintf( esc_html__( 'Alas. Just to let you know &mdash; order #%1$s belonging to %2$s has been cancelled:', 'easyReservations' ), esc_html( $order->get_order_number() ), esc_html( $order->get_formatted_full_name() ) ) . "\n\n";
