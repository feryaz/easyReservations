 ...
 *
 * This template can be overridden by copying it to yourtheme/easyreservations/emails/plain/customer-completed-order.php.
 *
...
echo esc_html__( 'We have finished processing your order.', 'easyReservations' ) . "\n\n";
