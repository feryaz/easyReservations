 ...
 *
 * This template can be overridden by copying it to yourtheme/easyreservations/emails/plain/admin-new-order.php.
 *
...
echo sprintf( esc_html__( 'You’ve received the following order from %s:', 'easyReservations' ), esc_html( $order->get_formatted_full_name() ) ) . "\n\n";
