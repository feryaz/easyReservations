 ...
 *
 * This template can be overridden by copying it to yourtheme/easyreservations/emails/plain/admin-failed-order.php
 *
...
echo sprintf( esc_html__( 'Payment for order #%1$s from %2$s has failed. The order was as follows:', 'easyReservations' ), esc_html( $order->get_order_number() ), esc_html( $order->get_formatted_full_name() ) ) . "\n\n";
