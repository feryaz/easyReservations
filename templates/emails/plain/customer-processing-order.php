 ...
 *
 * This template can be overridden by copying it to yourtheme/easyreservations/emails/plain/customer-processing-order.php.
 *
...
echo sprintf( esc_html__( 'Just to let you know &mdash; we\'ve received your order #%s, and it is now being processed:', 'easyReservations' ), esc_html( $order->get_order_number() ) ) . "\n\n";
