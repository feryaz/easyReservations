 ...
 *
 * This template can be overridden by copying it to yourtheme/easyreservations/emails/email-customer-details.php.
 *
...
<?php if ( ! empty( $fields ) ) : ?>
    <div style="font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; margin-bottom: 40px;">
        <h2><?php esc_html_e( 'Customer details', 'easyReservations' ); ?></h2>
        <ul>
