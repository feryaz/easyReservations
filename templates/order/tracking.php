 ...
 * Order tracking
 *
 * This template can be overridden by copying it to yourtheme/easyreservations/order/tracking.php.
 *
	...
	echo wp_kses_post(
		apply_filters(
			...
			/* translators: 1: order number 2: order date 3: order status */
				...
				'<mark class="order-status">' . ER_Order_Status::get_title( $order->get_status() ) . '</mark>'
			)
		)
	);
	?>
