...
class ER_Orders_Tracking {
	...
	public function init() {
		...
		add_filter( 'easyreservations_order_search_results', array( $this, 'track_order_search' ), 10, 3 );
	}
	...
	public function track_order_search( $order_ids, $term, $search_fields ) {
		// Since `easyreservations_order_search_results` can run in the front-end context, exit if get_current_screen isn't defined.
		...
		if ( 'edit-shop_order' === $screen->id ) {
			...
			ER_Tracks::record_event( 'orders_view_search' );
		}
