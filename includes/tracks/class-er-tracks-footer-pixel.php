...
/**
 * ER_Tracks_Footer_Pixel class.
 */
class ER_Tracks_Footer_Pixel {
	/**
	 * Singleton instance.
	 *
	 * @var ER_Tracks_Footer_Pixel
	 */
	 ...
	 *
	 * @return ER_Tracks_Footer_Pixel
	 */
	public static function instance() {
		if ( is_null( self::$instance ) ) {
			self::$instance = new ER_Tracks_Footer_Pixel();
		}
	 ...
	 *
	 * @param ER_Tracks_Event $event Event to track.
	 */
	...
	public function send_tracks_requests() {
		...
		foreach ( $this->events as $event ) {
			ER_Tracks_Client::record_event( $event );
		}
	}
}
