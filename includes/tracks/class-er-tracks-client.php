...
/**
 * ER_Tracks_Client class.
 */
class ER_Tracks_Client {
	...
	public static function record_event( $event ) {
		if ( ! $event instanceof ER_Tracks_Event ) {
			$event = new ER_Tracks_Event( $event );
		}
	...
	public static function get_anon_id() {
		...
		if ( ! isset( $anon_id ) ) {
			...
			if ( isset( $_COOKIE['tk_ai'] ) ) {
				...
				$anon_id = 'easy:' . base64_encode( $binary );
			}
		}
