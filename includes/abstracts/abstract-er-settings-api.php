            ...
            <td class="forminp">
                <fieldset>
					...
					<?php if ( $data['select_buttons'] ) : ?>
                        <br/>
                        <a class="select_all button" href="#"><?php esc_html_e( 'Select all', 'easyReservations' ); ?></a>
                        <a class="select_none button" href="#"><?php esc_html_e( 'Select none', 'easyReservations' ); ?></a>
					<?php endif; ?>
                </fieldset>
            </td>
        </tr>
