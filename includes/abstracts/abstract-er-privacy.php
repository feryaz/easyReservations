<?php
/**
 * easyReservations abstract privacy class.
 *
 ...
 * @package  easyReservations/Abstracts
 */
abstract class ER_Abstract_Privacy {
	/**
	...
	/**
	 * ER_Abstract_Privacy Constructor.
	 *
	...
	protected function init() {
		...
		// We set priority to 5 to help easyReservations's findings appear before those from extensions in exported items.
	...
	/**
	 * Adds the privacy message on ER privacy page.
	 */
