...
class ER_Data_Store {
	...
	/**
	 * Contains an array of default ER supported data stores.
	 * Format of object name => class name.
	 * Example: 'order' => 'ER_Order_Data_Store_CPT'
	 * You can also pass something like order_<type> for order stores and
	 * that type will be used first when available, if a store is requested like
	 * this and doesn't exist, then the store would fall back to 'order'.
	 * Ran through `easyreservations_data_stores`.
	 *
	 * @var array
	 */
	 ...
	 *
	 * @param ER_Data $data easyReservations data instance.
	 */
