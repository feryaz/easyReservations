...
<div style="width:99%;line-height: 22px;margin-top: 5px;height:30px">
    <ul class="subsubsub" style="display:block;margin-top:3px">
        <li>
            <a href="<?php echo esc_url( admin_url( 'admin.php?page=er-settings&tab=form' ) ); ?>" class="<?php if ( empty( $current_form_name ) ) echo 'current'; ?>"><?php esc_html_e( 'Standard', 'easyReservations' ); ?></a>
        </li>
        <?php
        ...
        <div class="table">
            <table class="formtable">
                ...
                <tr attr="units">
                    ...
                    <td><strong><?php esc_html_e( 'Billing units', 'easyReservations' ); ?></strong><br><i><?php esc_html_e( 'Select field to choose length of stay', 'easyReservations' ); ?></i>
                    </td>
                    <td>1</td>
                </tr>
                </tbody>
...
<script type="text/javascript">
    ...
    function changeHiddenOption(tag, typ) {
        ...
        if (type == 'resource') {
            ...
            if (!tag || !tag[2]) tag = {2: '<?php echo esc_html( er_date_format() ); ?>'};
