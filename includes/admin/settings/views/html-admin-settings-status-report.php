...
<table class="er_status_table widefat" cellspacing="0">
    <thead>
    <tr>
        <th colspan="3" data-export-label="Settings"><h2><?php esc_html_e( 'Settings', 'easyReservations' ); ?></h2></th>
    </tr>
    </thead>
    <tbody>
    <tr>
...
<table class="er_status_table widefat" cellspacing="0">
    <thead>
    <tr>
        <th colspan="3" data-export-label="ER Pages"><h2><?php esc_html_e( 'easyReservations pages', 'easyReservations' ); ?></h2>
        </th>
    </tr>
    </thead>
    <tbody>
