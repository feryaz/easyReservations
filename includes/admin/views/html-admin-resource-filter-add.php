    ...
    <div id="filter_form_price" class="hide-it">
        ...
        <table class="form-table">
            ...
            <tr class="filter-children-price-container hidden">
                <th><label for="filter-children-price"><?php esc_html_e( 'Children price', 'easyReservations' ); ?></label></th>
                <td>
                    <span class="input-wrapper">
...
<script language="javascript" type="text/javascript">
    ...
    function setWord(v) {
        if (v == 'early' || v == 'stay') var verb = '<?php echo er_date_get_interval_label( isset( $resource ) ? $resource->get_billing_interval() : DAY_IN_SECONDS ); ?>';
        if (v == 'pers') var verb = '<?php echo addslashes( esc_html__( 'adults and children', 'easyReservations' ) ); ?>';
        if (v == 'adul') var verb = '<?php echo addslashes( esc_html__( 'adults', 'easyReservations' ) ); ?>';
        if (v == 'child') var verb = '<?php echo addslashes( esc_html__( 'children', 'easyReservations' ) ); ?>';
