<?php
/**
 * Class ER_Email_Customer_Processing_Order file.
 *
...
if ( ! class_exists( 'ER_Email_Customer_Processing_Order', false ) ) :
	 ...
	 *
	 * @class       ER_Email_Customer_Processing_Order
	 * @package     easyReservations/Classes/Emails
	 * @extends     ER_Email
	 */
	class ER_Email_Customer_Processing_Order extends ER_Email {
		...
		public function __construct() {
			...
			$this->title          = __( 'Processing order', 'easyReservations' );
			$this->description    = __( 'This is an order notification sent to customers containing order details after payment.', 'easyReservations' );
			...
			add_action( 'easyreservations_order_status_on-hold_to_processing_notification', array( $this, 'trigger' ), 10, 2 );
...
return new ER_Email_Customer_Processing_Order();
