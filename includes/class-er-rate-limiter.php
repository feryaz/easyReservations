 ...
 *
 * ER_Rate_Limiter::set_rate_limit( "{$my_action_name}_{$user_id}", $delay );
 *
 ...
 *
 * if ( ER_Rate_Limiter::retried_too_soon( "{$my_action_name}_{$user_id}" ) ) {
...
class ER_Rate_Limiter {
	...
	public static function storage_id( $action_id ) {
		return 'easyreservations_rate_limit_' . $action_id;
	}
